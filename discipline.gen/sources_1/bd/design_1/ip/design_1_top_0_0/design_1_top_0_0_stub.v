...
(* CHECK_LICENSE_TYPE = "design_1_top_0_0,top,{}" *) (* CORE_GENERATION_INFO = "design_1_top_0_0,top,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=top,x_ipVersion=1.0,x_ipCoreRevision=2114070010,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "HLS" *) (* X_CORE_INFO = "top,Vivado 2024.2" *) (* hls_module = "yes" *) 
module design_1_top_0_0(ap_clk, ap_rst_n, to_test_TDATA, 
  to_test_TREADY, to_test_TVALID)
/* synthesis syn_black_box black_box_pad_pin="ap_rst_n,to_test_TDATA[31:0],to_test_TREADY,to_test_TVALID" */
